...
class Informes{
	...
	function encabezadoInforme($nombreinforme="",$titulo_="",$fechainicial_,$fechafinal_,$mostrarFecha=true)
	{
	   $html="";
        ...
        $logo = (!empty($datoempresa[0]['rutalogo'])) ? base_url($datoempresa[0]['rutalogo']) : base_url('img/logo_vacio.png');
        $html.="<table class='encabezainfo'>
                <tr>
                    <td colspan='".$colspan."'></td>
                </tr>
                <tr>
                    <td colspan='".$colspan."'><img height='50px' width='120px' src='".$logo."' alt='".$datoempresa[0]['nombreempresa']."' /></td>
                </tr>
                <tr>
                    <td colspan='".$colspan."'></td>
                </tr>
