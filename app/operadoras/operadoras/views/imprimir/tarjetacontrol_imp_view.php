...
-->
	...
	<tr>
        <td class="n1_2"><?php echo $datonumerorevision; ?></td>
        <td class="n1_2"><?php echo $datorevision_fechafinal; ?></td>
        <td rowspan="2"></td>
        <td>&nbsp;</td>
    </tr>
	<tr>
    	<td class="n1_2"><?php echo $datonumerosoat; ?></td>
        <td class="n1_2"><?php echo $datosoat_fechafinal; ?></td>
        <td>&nbsp;</td>
    </tr>
</table>
<!-- 
