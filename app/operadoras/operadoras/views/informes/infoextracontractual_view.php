...
<div class="titulo-modulo">Informe de Seguros Extra-Contractuales</div>
<div class="contenido-modulo contenido-informe border border-radius border-shadow">
    <form target="_blank" method="post" name="form_infoextracontractual" id="form_infoextracontractual" action="<?=site_url('informes/infoextracontractual/resultado')?>">
        <input type="hidden" name="idinfoextracontractual" id="idinfoextracontractual" value="<?php if(!empty($datoidinfoextracontractual)) echo $datoidinfoextracontractual?>" />
        <div class="form">
