...
<div class="titulo-modulo">Informe de Soat</div>
<div class="contenido-modulo contenido-informe border border-radius border-shadow">
    <form target="_blank" method="post" name="form_infosoat" id="form_infosoat" action="<?=site_url('informes/infosoat/resultado')?>">
