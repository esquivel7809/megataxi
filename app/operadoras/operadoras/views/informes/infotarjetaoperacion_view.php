...
<div class="titulo-modulo">Informe de Tarjetas de Operaci&oacute;n</div>
<div class="contenido-modulo contenido-informe border border-radius border-shadow">
    <form target="_blank" method="post" name="form_infotarjetaoperacion" id="form_infotarjetaoperacion" action="<?=site_url('informes/infotarjetaoperacion/resultado')?>">
        <input type="hidden" name="idinfotarjetaoperacion" id="idinfotarjetaoperacion" value="<?php if(!empty($datoidinfotarjetaoperacion)) echo $datoidinfotarjetaoperacion?>" />
        <div class="form">
