...
?>
    ...
    <table>
        <tr>
            ...
            <td nowrap="nowrap">Nº Revisión</td>
            <td nowrap="nowrap">Fecha de Vencim.</td>
            <td nowrap="nowrap">C.D.A.</td>
