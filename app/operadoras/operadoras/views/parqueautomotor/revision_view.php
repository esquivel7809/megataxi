...
<div class="titulo-modulo">Registro de Revisi&oacute;n Tecnico-Mecanica</div>
<div class="contenido-modulo border border-radius border-shadow">
    <form method="post" name="form_revision" id="form_revision" action="<?=site_url('parqueautomotor/revision/registro')?>">
        <input type="hidden" name="idrevision" id="idrevision" value="<?php if(!empty($datoidrevision)) echo $datoidrevision?>" />
        <div class="form">
            <div>
                <label>Placa:</label>
            ...
            <?php echo $this->load->view('parqueautomotor/revisionform_view'); ?>
            <div>
                <label>Activo:</label>
