...
<div class="titulo-modulo">Informe de Revisi&oacute;n Tecnicomecacnica</div>
<div class="contenido-modulo contenido-informe border border-radius border-shadow">
    <form target="_blank" method="post" name="form_inforevision" id="form_inforevision" action="<?=site_url('informes/inforevision/resultado')?>">
        <input type="hidden" name="idinforevision" id="idinforevision" value="<?php if(!empty($datoidinforevision)) echo $datoidinforevision?>" />
