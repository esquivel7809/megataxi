<script>
	$(document).ready(function(){
		$('#form_tarjetaoperacion').html5form({
...
<div class="titulo-modulo">Registro de Tarjetas de Operaci&oacute;n</div>
<div class="contenido-modulo border border-radius border-shadow">
    <form method="post" name="form_tarjetaoperacion" id="form_tarjetaoperacion" action="<?=site_url('parqueautomotor/tarjetaoperacion/registro')?>">
        <input type="hidden" name="idtarjetaoperacion" id="idtarjetaoperacion" value="<?php if(!empty($datoidtarjetaoperacion)) echo $datoidtarjetaoperacion?>" />
        <div class="form">
            <div>
                <label>Placa:</label>
