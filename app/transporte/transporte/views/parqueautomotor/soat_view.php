...
<div class="titulo-modulo">Registro de SOAT</div>
<div class="contenido-modulo border border-radius border-shadow">
    <form method="post" name="form_soat" id="form_soat" action="<?=site_url('parqueautomotor/soat/registro')?>">
        <input type="hidden" name="idsoat" id="idsoat" value="<?php if(!empty($datoidsoat)) echo $datoidsoat?>" />
        <div class="form">
            <div>
                <label>Placa:</label>
