<script>
    ...
    <div>
        ...
        <div class="wrapper-select-form">
            <select name="idaseguradoraextra" id="idaseguradoraextra" required="required" title="CDA" >
            <?=$cda?>
            </select>
        </div>
    </div>
    <div>
        ...
        <input type="text" name="numeroextracontractual" id="numeroextracontractual" required="required" title="Nº Certificado" placeholder="Nº Certificado" value="<?php if(!empty($datonumeroextracontractual)) echo $datonumeroextracontractual?>" />
    </div>
    <div>
