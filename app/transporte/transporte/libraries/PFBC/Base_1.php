<?php
abstract class Base {
	public function configure(array $properties = null) { //print_r($properties);
        if(!empty($properties)) {
            ...
            //$available = array_keys(get_class_vars($class)); # original
            //$available = array_keys(get_object_vars($this));
            //print_r($available);
            //echo"<br />";
            ...
            foreach($properties as $property => $value) {
				...
				if($property != "attributes") { 
					...
					if(isset($method_reference["set" . $property])){ //echo"<br />".$property." ".$value;
