...
class Vehiculoradiotelefono extends CI_Controller {
	/**
	...
	public function index($array_datos)
	{
        ...
        $data['vista_contenido_mod']=array("comunicaciones/vehiculoradiotelefono_view");
    ...
    public function registro()
    {
        ...
        if($arraypost["Guardar"]=="Guardar")
        {
            ...
            $condicionOtroRadio = array('idradiotelefono' => $arraypost['idradiotelefono'], 'activo'=>'1', 'idempresa'=> $this->idempresa);
			...
			if(!empty($arrayOtroRadio)){
				...
				$array_datos['mensaje']['msg']="El radiotelefono ya esta en uso";
				$array_datos['mensaje']['class']="error";
				$array_datos['datos']=$arraypost;
			}else{
				$campos['idvehiculoradiotelefono']      =   $this->tabla->MaximoDato("idvehiculoradiotelefono") + 1;
				$campos['idvehiculo']   	=   $arraypost['idvehiculo'];
				$campos['idradiotelefono']	=   $arraypost['idradiotelefono'];
...
/* Location: ./application/controllers/conductores/vehiculoradiotelefono.php */