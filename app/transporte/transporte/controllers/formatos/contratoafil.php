...
class Contratoafil extends CI_Controller {
    ...
    */
	...
	{
        $data['vista_contenido_mod']=array("formatos/contratoafil_view");
		
        //Array que define los titulos que llevaran los criterios
        $Titulo=array('Digite placa del vehiculo, cedula o nombre del propietario');
        //Array que define los campos id' de los criterios en laBD
        $CamposId=array('idvehiculopropietario');
        //Array que define la ruta para la busqueda
        $rutaBusqueda=array(site_url('formatos/data/consultarvehiculoformatoafil'));
