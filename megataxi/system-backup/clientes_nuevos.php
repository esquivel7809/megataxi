...
<table border="1">
  ...
  <?php do { ?>
    <tr>
	  ...
	  <td><a onclick="abrir('/megataxi/system/forms/directorio.form.php','','&telefono=<?php echo $row_clientes_nuevos[telefono]; ?>&modo=new_automatic','Edicion');ver_div_edit();">Editar</a></td>
    </tr>
