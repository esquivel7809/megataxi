...
<table border="1" align="center">
  ...
  ?>
    <tr>
      ...
      <td><form action="../process/servicio.process.php" method="post" target="IFrameProcess" id="EliminaServicio<?php echo $row_servicios[servicio_id]; ?>"><input type="hidden" value="<?php echo $row_servicios[servicio_id] ?>" name="servicio_id" /><input type="hidden" name="modo" value="delete" /><img src="../images/b_drop.png" onclick="if(confirm('Esta seguro que desea eliminar el registro')){enviar('EliminaServicio<?php echo $row_servicios[servicio_id]; ?>');}" style="cursor:pointer;" /></form></td>	  
    </tr>
