...
include('../process/validar.php');
   ...
   #include("../libraries/phpmailer/class.phpmailer.php");
	...
	if($_SESSION[datos]->perfil==2){
		...
		##SQL QUE CUENTA LOS SERVICIOS QUE FUERON PEDIDOS AUTOM�TICAMENTE
		...
		$texto=$tabla_todos.$tabla_resumen;
		$para= "jorgesoftware2005@gmail.com";

		$cabeceras  = 'MIME-Version: 1.0' . "\r\n";
		$cabeceras .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
		$cabeceras .= "To: TO <jorgesoftware2005@gmail.com>  \r\n";
		$cabeceras .= 'From: FROM <jorgesoftware2005@gmail.com>'."\r\n";

//		$cabeceras .= 'Cc: reportes@fcosystems.com'."\r\n";
		
		$asunto="Reporte de servicios de ".$_SESSION[datos]->nombre." del ".$row_turno['inicio']." desde las ".$hora_Inicio_Turno." hasta ".$ahora1;
		echo mail($para,$asunto,$texto,$cabeceras);
		//mail("megataxi8@hotmail.com",$asunto,$texto,$cabeceras);
		//mail("iraideguzman@hotmail.com",$asunto,$texto,$cabeceras);
/*	
		$mail = new PHPMailer();
		$mail->SMTPDebug = 1;
		...
		$titulo_Reporte = "Reporte de prueba";
		$mail = new PHPMailer();
		$mail->SMTPDebug = 1;
		$mail->IsSMTP();  // telling the class to use SMTP
		$mail->IsHTML(true);
		...
		//$mail->AddAddress("megataxi21@hotmail.com", "Iraide Guzman");
		#$mail->Body = wordwrap($msg , 200);
		$mail->Body = "Mensaje de prueba desde megataxi";
